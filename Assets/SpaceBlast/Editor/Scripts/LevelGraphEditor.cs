    ...
    void BakeNav()
    {
        ...
        foreach (Node n1 in nodes)
        {
            ...
            foreach (Node n2 in nodes)
            {
                ...
                RaycastHit hitInfo;
                bool hit = Physics.SphereCast(n1.transform.position, 0.75f, relative.normalized, out hitInfo, relative.magnitude, levelGraph.bakeLayerMask, QueryTriggerInteraction.Ignore);
